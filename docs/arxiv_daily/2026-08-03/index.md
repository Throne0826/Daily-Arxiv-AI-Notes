---
title: "arXiv 每日论文 · 2026-08-03"
description: "2026-08-03 筛选出的 12 篇 AI arXiv 新论文中文解读。"
---

# arXiv 每日论文：2026-08-03

<div class="daily-overview" markdown="1">

收录 **12** 篇不重复论文，形成 **24** 条分类记录。多标签论文会同时出现在所有相关方向中。
...
#### [Copy Less, Ground More: Overcoming Repetitive Copying in Long-Context Reasoning via Evidence-Aware Reinforcement Learning](llm_reasoning/copy-less-ground-more-overcoming-repetitive-copying-in-long-context-reasoning-via-evidence-aware-rei.md)
...
#### [How Hard Does It Think? Analyzing Step-Aware Reasoning Energy in LLM Chain-of-Thought Trajectories](llm_reasoning/how-hard-does-it-think-analyzing-step-aware-reasoning-energy-in-llm-chain-of-thought-trajectories.md)
...
#### [Metaphor-Induced Algorithmic Steering: Cross-Domain Procedural Transfer in LLM Code Generation](llm_reasoning/metaphor-induced-algorithmic-steering-cross-domain-procedural-transfer-in-llm-code-generation.md)
...
#### [ThinkReset: Learnable Intermediate Interface Construction for Bounded-Context Long-Horizon Reasoning](llm_reasoning/thinkreset-learnable-intermediate-interface-construction-for-bounded-context-long-horizon-reasoning.md)
...
#### [To Add Is Machine, To Delete Is Human: Measuring and Mitigating Deletion Avoidance in LLM Code Editing](llm_reasoning/to-add-is-machine-to-delete-is-human-measuring-and-mitigating-deletion-avoidance-in-llm-code-editing.md)
...
#### [When Iterative RAG Beats Ideal Evidence: A Diagnostic Study in Scientific Multi-hop Question Answering](llm_reasoning/when-iterative-rag-beats-ideal-evidence-a-diagnostic-study-in-scientific-multi-hop-question-answerin.md)
