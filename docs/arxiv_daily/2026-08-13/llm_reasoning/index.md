...
#### [Chain-of-Thought Shows the Path to a Tree: Realizing Branching Complexity](chain-of-thought-shows-the-path-to-a-tree-realizing-branching-complexity.md)
...
#### [Claim-Level Reliability Assessment for Efficient Test-Time Reasoning](claim-level-reliability-assessment-for-efficient-test-time-reasoning.md)
...
#### [DexterSQL: Deep Schema Exploration and Rule-based Correction for Text-to-SQL Generation](dextersql-deep-schema-exploration-and-rule-based-correction-for-text-to-sql-generation.md)
...
#### [Policy-as-logic for robust reasoning over rules](policy-as-logic-for-robust-reasoning-over-rules.md)
...
#### [Reinforcing Step-level Reasoning for Effective Self-Correction in LLMs](reinforcing-step-level-reasoning-for-effective-self-correction-in-llms.md)
...
#### [Retrofitting Recurrent Depth into a Pretrained Language Model: Installation, Extrapolation, Transfer, and Retention at Two Parameter Budgets](retrofitting-recurrent-depth-into-a-pretrained-language-model-installation-extrapolation-transfer-an.md)
...
#### [When Self-Consistency Backfires: Majority Vote Hurts the Majority of Hard Science Problems for Small LLMs](when-self-consistency-backfires-majority-vote-hurts-the-majority-of-hard-science-problems-for-small.md)
