...
<h1>AI 研究版图</h1>
<p>把 390 篇论文看成一个持续变化的研究网络：节点表示细分方向，节点大小表示累计论文量，连线来自同一论文的多标签共现。</p>
</header>

<section class="research-map__metrics" aria-label="论文版图概览">
<div><strong>390</strong><span>不重复论文</span></div>
<div><strong>835</strong><span>方向归属</span></div>
...
<a class="research-node" href="llm_reasoning/" style="--node-size:7.60rem" data-map-group="llm" title="LLM Reasoning：288 篇"><strong>288</strong><span>LLM Reasoning</span><small>最新日 +11</small></a>
<a class="research-node" href="llm_agent/" style="--node-size:5.71rem" data-map-group="llm" title="LLM Agent：57 篇"><strong>57</strong><span>LLM Agent</span><small>最新日 -1</small></a>
<a class="research-node" href="multi_agent/" style="--node-size:4.89rem" data-map-group="llm" title="Multi-Agent：12 篇"><strong>12</strong><span>Multi-Agent</span><small>最新日持平</small></a>
<a class="research-node" href="llm_alignment/" style="--node-size:5.54rem" data-map-group="llm" title="对齐 / RLHF：45 篇"><strong>45</strong><span>对齐 / RLHF</span><small>最新日持平</small></a>
<a class="research-node" href="llm_safety/" style="--node-size:5.07rem" data-map-group="llm" title="LLM 安全：19 篇"><strong>19</strong><span>LLM 安全</span><small>最新日持平</small></a>
<a class="research-node" href="hallucination/" style="--node-size:4.48rem" data-map-group="llm" title="幻觉检测：2 篇"><strong>2</strong><span>幻觉检测</span><small>最新日持平</small></a>
<a class="research-node" href="llm_evaluation/" style="--node-size:5.96rem" data-map-group="llm" title="LLM 评测：77 篇"><strong>77</strong><span>LLM 评测</span><small>最新日 +3</small></a>
<a class="research-node" href="llm_efficiency/" style="--node-size:5.32rem" data-map-group="llm" title="LLM 效率：31 篇"><strong>31</strong><span>LLM 效率</span><small>最新日 +2</small></a>
<a class="research-node" href="llm_pretraining/" style="--node-size:4.48rem" data-map-group="llm" title="预训练：2 篇"><strong>2</strong><span>预训练</span><small>最新日持平</small></a>
<a class="research-node" href="knowledge_editing/" style="--node-size:4.55rem" data-map-group="llm" title="知识编辑：3 篇"><strong>3</strong><span>知识编辑</span><small>最新日持平</small></a>
<a class="research-node" href="llm_interpretability/" style="--node-size:5.05rem" data-map-group="llm" title="LLM 机制与可解释性：18 篇"><strong>18</strong><span>LLM 机制与可解释性</span><small>最新日持平</small></a>
<a class="research-node" href="llm_nlp/" style="--node-size:6.62rem" data-map-group="llm" title="LLM 其他：146 篇"><strong>146</strong><span>LLM 其他</span><small>最新日 +5</small></a>
</div>
</section>
...
<div class="research-node-field">
<a class="research-node" href="image_generation/" style="--node-size:4.40rem" data-map-group="generation_multimodal" title="图像生成：1 篇"><strong>1</strong><span>图像生成</span><small>最新日持平</small></a>
<a class="research-node" href="video_generation/" style="--node-size:4.48rem" data-map-group="generation_multimodal" title="视频生成：2 篇"><strong>2</strong><span>视频生成</span><small>最新日持平</small></a>
<a class="research-node" href="multimodal_vlm/" style="--node-size:5.16rem" data-map-group="generation_multimodal" title="多模态 VLM：23 篇"><strong>23</strong><span>多模态 VLM</span><small>最新日持平</small></a>
<a class="research-node" href="vlm_reasoning/" style="--node-size:5.20rem" data-map-group="generation_multimodal" title="VLM Reasoning：25 篇"><strong>25</strong><span>VLM Reasoning</span><small>最新日持平</small></a>
<a class="research-node" href="vlm_efficiency/" style="--node-size:4.69rem" data-map-group="generation_multimodal" title="VLM Efficiency：6 篇"><strong>6</strong><span>VLM Efficiency</span><small>最新日持平</small></a>
</div>
</section>
...
<div class="research-node-field">
<a class="research-node" href="autonomous_driving/" style="--node-size:4.55rem" data-map-group="decision_embodied" title="自动驾驶：3 篇"><strong>3</strong><span>自动驾驶</span><small>最新日持平</small></a>
<a class="research-node" href="robotics/" style="--node-size:5.54rem" data-map-group="decision_embodied" title="机器人 / 具身智能：45 篇"><strong>45</strong><span>机器人 / 具身智能</span><small>最新日 -1</small></a>
<a class="research-node" href="reinforcement_learning/" style="--node-size:5.10rem" data-map-group="decision_embodied" title="强化学习：20 篇"><strong>20</strong><span>强化学习</span><small>最新日持平</small></a>
<a class="research-node" href="recommender/" style="--node-size:4.83rem" data-map-group="decision_embodied" title="推荐系统：10 篇"><strong>10</strong><span>推荐系统</span><small>最新日持平</small></a>
</div>
</section>
...
<p>共有 117 篇论文同时进入这两个方向。</p>
</aside>
</div>
<ol class="research-connection-list">
<li><a href="llm_nlp/">LLM 其他</a><span>×</span><a href="llm_reasoning/">LLM Reasoning</a><strong>117</strong></li>
<li><a href="llm_evaluation/">LLM 评测</a><span>×</span><a href="llm_reasoning/">LLM Reasoning</a><strong>60</strong></li>
<li><a href="llm_alignment/">对齐 / RLHF</a><span>×</span><a href="llm_reasoning/">LLM Reasoning</a><strong>40</strong></li>
<li><a href="llm_evaluation/">LLM 评测</a><span>×</span><a href="llm_nlp/">LLM 其他</a><strong>35</strong></li>
