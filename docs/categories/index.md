...
<h1>AI 研究版图</h1>
<p>把 367 篇论文看成一个持续变化的研究网络：节点表示细分方向，节点大小表示累计论文量，连线来自同一论文的多标签共现。</p>
</header>

<section class="research-map__metrics" aria-label="论文版图概览">
<div><strong>367</strong><span>不重复论文</span></div>
<div><strong>790</strong><span>方向归属</span></div>
<div><strong>73%</strong><span>多标签论文</span></div>
<div><strong>63</strong><span>跨主域论文</span></div>
</section>
...
<a class="research-node" href="llm_reasoning/" style="--node-size:7.60rem" data-map-group="llm" title="LLM Reasoning：265 篇"><strong>265</strong><span>LLM Reasoning</span><small>最新日 +17</small></a>
<a class="research-node" href="llm_agent/" style="--node-size:5.76rem" data-map-group="llm" title="LLM Agent：56 篇"><strong>56</strong><span>LLM Agent</span><small>最新日 +2</small></a>
...
<a class="research-node" href="llm_alignment/" style="--node-size:5.60rem" data-map-group="llm" title="对齐 / RLHF：45 篇"><strong>45</strong><span>对齐 / RLHF</span><small>最新日 -1</small></a>
<a class="research-node" href="llm_safety/" style="--node-size:5.11rem" data-map-group="llm" title="LLM 安全：19 篇"><strong>19</strong><span>LLM 安全</span><small>最新日 +1</small></a>
<a class="research-node" href="hallucination/" style="--node-size:4.50rem" data-map-group="llm" title="幻觉检测：2 篇"><strong>2</strong><span>幻觉检测</span><small>最新日持平</small></a>
<a class="research-node" href="llm_evaluation/" style="--node-size:5.97rem" data-map-group="llm" title="LLM 评测：72 篇"><strong>72</strong><span>LLM 评测</span><small>最新日 +6</small></a>
<a class="research-node" href="llm_efficiency/" style="--node-size:5.32rem" data-map-group="llm" title="LLM 效率：29 篇"><strong>29</strong><span>LLM 效率</span><small>最新日持平</small></a>
<a class="research-node" href="llm_pretraining/" style="--node-size:4.50rem" data-map-group="llm" title="预训练：2 篇"><strong>2</strong><span>预训练</span><small>最新日持平</small></a>
...
<a class="research-node" href="llm_interpretability/" style="--node-size:5.04rem" data-map-group="llm" title="LLM 机制与可解释性：16 篇"><strong>16</strong><span>LLM 机制与可解释性</span><small>最新日持平</small></a>
<a class="research-node" href="llm_nlp/" style="--node-size:6.63rem" data-map-group="llm" title="LLM 其他：135 篇"><strong>135</strong><span>LLM 其他</span><small>最新日 +4</small></a>
</div>
</section>
...
<a class="research-node" href="video_generation/" style="--node-size:4.50rem" data-map-group="generation_multimodal" title="视频生成：2 篇"><strong>2</strong><span>视频生成</span><small>最新日持平</small></a>
<a class="research-node" href="multimodal_vlm/" style="--node-size:5.20rem" data-map-group="generation_multimodal" title="多模态 VLM：23 篇"><strong>23</strong><span>多模态 VLM</span><small>最新日持平</small></a>
<a class="research-node" href="vlm_reasoning/" style="--node-size:5.24rem" data-map-group="generation_multimodal" title="VLM Reasoning：25 篇"><strong>25</strong><span>VLM Reasoning</span><small>最新日持平</small></a>
...
<a class="research-node" href="robotics/" style="--node-size:5.59rem" data-map-group="decision_embodied" title="机器人 / 具身智能：44 篇"><strong>44</strong><span>机器人 / 具身智能</span><small>最新日持平</small></a>
<a class="research-node" href="reinforcement_learning/" style="--node-size:5.13rem" data-map-group="decision_embodied" title="强化学习：20 篇"><strong>20</strong><span>强化学习</span><small>最新日 +1</small></a>
<a class="research-node" href="recommender/" style="--node-size:4.86rem" data-map-group="decision_embodied" title="推荐系统：10 篇"><strong>10</strong><span>推荐系统</span><small>最新日持平</small></a>
</div>
</section>
